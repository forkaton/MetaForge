...
interface DraftRepository {
    ...
    suspend fun pickHero(slotIndex: Int, isAlly: Boolean, isBan: Boolean = false, hero: Hero)
    suspend fun removeHero(slotIndex: Int, isAlly: Boolean, isBan: Boolean = false)
